  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950">
      <div className="w-full max-w-md p-8 bg-gray-900 rounded-2xl border border-gray-800">
        <h1 className="text-3xl font-bold text-white text-center mb-2">Join MathArena</h1>
        <p className="text-gray-400 text-center mb-8">Create your account and start competing</p>
