  ...
  return (
    <div className="min-h-screen bg-page flex flex-col relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-6">
              <Link href="/leaderboard" className="text-[10px] tracking-[1.5px] text-ink-muted hover:text-ink-secondary transition-colors">
                RANKINGS
              </Link>
              <Link
                href="/login"
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center relative z-[1]">
        <div className="text-[10px] tracking-[4px] text-ink-muted mb-6">
          COMPETITIVE MENTAL MATH
        </div>
        <h1 className="font-serif text-5xl md:text-6xl font-light text-ink leading-tight mb-5 tracking-tight">
          Where Numbers<br />Become <em className="text-ink-secondary">Sport</em>
        </h1>
        <p className="text-[15px] text-ink-tertiary max-w-[420px] leading-relaxed font-light mb-10">
      ...
      <div className="relative z-[1] flex border-t border-edge-faint">
        <div className="flex-1 py-10 px-6 text-center border-r border-edge-faint">
          <div className="font-serif text-3xl font-light italic text-ink-tertiary mb-4">&times;</div>
        ...
        <div className="flex-1 py-10 px-6 text-center border-r border-edge-faint">
          <div className="font-serif text-3xl font-light italic text-ink-tertiary mb-4">&Sigma;</div>
        ...
        <div className="flex-1 py-10 px-6 text-center">
          <div className="font-serif text-3xl font-light italic text-ink-tertiary mb-4">&part;</div>
      ...
      {/* Footer */}
      <footer className="border-t border-edge-faint py-8 text-center text-[10px] tracking-[2px] text-ink-faint relative z-[1]">
